          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <div className="emotions-container">
                {[
                  { id: 1, name: "Happy", image: "./public/images/icon_greenA.svg" },
                  { id: 2, name: "Angry", image: "./public/images/icon_red.svg" },
                  { id: 3, name: "Surprised", image: "./public/images/icon_pink.svg" },
                  { id: 4, name: "Confused", image: "./public/images/icon_blue.svg" }
                ].map((emotion) => (
                  <button
                    key={emotion.id}
