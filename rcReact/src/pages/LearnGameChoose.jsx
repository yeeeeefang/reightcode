...
import '../assets/scss/LearnGameChoose.scss'
  ...
  return (
    <section id="LearnGameChooseall">
      ...
      <div className='LearnChoose-img-position'>
        <img className='LearnChoose-img-position-1' src="../public/images/GameDecoA.svg" alt="" />
        <img className='LearnChoose-img-position-2' src="../public/images/GameDecoB.svg" alt="" />
        <img className='LearnChoose-img-position-3' src="../public/images/GameDecoC.svg" alt="" />
        <img className='LearnChoose-img-position-4' src="../public/images/GameDecoD.svg" alt="" />
      </div>
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <div className="gameaward-wrapper">
              ...
              <img className="gameaward" src="./public/images/award.svg" alt="" />
            </div>
            <p>是否要繼續遊玩？</p>
