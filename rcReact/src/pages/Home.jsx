            ...
            <section id="page-2">{/* 第二分頁 */}
                <div className="content-bk-1">
                    <div className="content-1">
                        <p className="text-1">用<span>程式</span>創造未來</p>
                        <p className="eng-text-1">Create the Future with Programming</p>
                    </div>
                    <div className="content-2">
                        <p className="text-1">用<span>英語</span>世界接軌</p>
                        <p className="eng-text-2">Connect the World in English</p>
                    </div>
                </div>
                <div className="content-bk-2">
                    <div className="content-3">
                        <div className="text-block-1">
                            ...
                            <p className="sml-text-2">為了因應科技時代的需求，
                                108課綱將「程式設計」正式納入中小學的資訊教育。
                                通過基礎程式學習來鍛鍊孩子的邏輯思考、創意思維和問題解決能力，
                                並且學會技術應用，強化數位素養。</p>
                        </div>
                ...
                <div className="content-bk">
                    ...
                    <div className="content-bk-4">
                        <div className="content-5">
                            <p className="text-3">課程 <span>枯燥乏味</span></p>
                            <p className="sml-text-3">傳統程式設計課程往往過於理論化，
                                <br />缺乏趣味性，
                                缺少互動和遊戲化的學習方式，<br />
                                使得學習變得單調、難以引起學生的持續動力。</p>
                        </div>
                        <div className="content-6">
                            <p className="text-3">額外補習課程 <span>費用昂貴</span></p>
                            <p className="sml-text-3">
                                市面上的程式補習班通常價格高昂，<br />
                                對許多家庭來說是額外的經濟負擔，<br />
                                導致家長對於讓孩子接觸這類課程望而卻步。
                            </p>
                        ...
                        <div className="content-7">
                            <p className="text-3"><span>時間及距離</span> 無法配合</p>
                            <p className="sml-text-3">許多補習班的上課時間與學校課程衝突，<br />
